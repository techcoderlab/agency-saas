<template>
  <div class="space-y-6">
    ...
    <div class="card p-4">
      <input v-model="search" type="text" placeholder="Search agents..." class="form-input pl-4" />
    </div>
      ...
      >
        <div class="card w-full max-w-lg">
          <div class="card-header">
            <h3 class="card-title">{{ isEditing ? 'Edit' : 'Create' }} Agent</h3>
          </div>
...
function openModal(c = null) {
  isEditing.value = !!c
  form.value = c ? { ...c } : { name: '', webhook_url: '', webhook_secret: '', welcome_message: '' }
